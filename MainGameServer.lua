...
local CONFIG = {
	...
	DOOR_NAMES = {
		...
		"Dark Café", "Fog Hotel", "Eclipse Bar", "Midnight Club",
...
local function CreateDoorWithVoid(doorX, faceZ, backZ, zDir, side, parent, buildingColor)
	...
	elseif eyeType == "HARVESTER_REAPER" then
		...
		local mouthY = eyeY - 0.4  -- Más arriba (antes era -0.9)
...
-- -------------------------------------------------------------------------------
-- STUN TIMES PER NPC TYPE - ¡AQUÍ MODIFICAS LOS TIEMPOS! 
-- -------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------??
-- STUN NPC FUNCTION - ¡VERSIÓN CORREGIDA QUE USA NPC_STUN_TIMES! 
-- -------------------------------------------------------------------------------
